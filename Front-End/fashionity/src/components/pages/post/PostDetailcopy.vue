      ...
      <div class="col-6">
        ...
        <div class="post-detail-header">
          <div class="post-detail-header-img">
            <img
              :src='this.post.profileImg || "@/assets/img/unknown.png"'
              alt="profileImg"
        ...
        <div class="row post-detail-image">
          <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner" v-for="(item, i) in this.post.images" :key="i">
        ...
        <div class="post-detail-like">
          ...
          <div>
            ...
            <span class="fw-bold" style="text-align: left">{{post.likeCount}}</span>
        ...
        <div class="post-detail-content">
          ...
          <div class="post-detail-content-hashtag">
            <a v-for="(tag, i) in post.hashtags" :key="i" style="color: skyblue">
              {{ tag }} &nbsp;
            </a>
          </div>
        </div>
